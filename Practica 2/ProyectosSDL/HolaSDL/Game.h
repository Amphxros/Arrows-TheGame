...
enum GameObjectIndex { BOW, ARROW, BALLOON, BUTTERFLY_,REWARD };
enum TextureIndex { BACKGROUND1,BACKGROUND2, BOW_1,BOW_2, BALLOONS, ARROW_1,BUTTERFLY_1, NUMBERS,BUBBLE };
